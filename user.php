...
if (isset($_POST['submit'])) {
	...
	$select = mysqli_query($conn, "SELECT * FROM user1 WHERE username='$username' AND password= '$password'") or die('query failed');
				...
				<div class="col-md">
					<div class="card bg-info mt-5 text-dark ">
						<div class="card-body text-center text-dark">
							...
							<h3 class="card-title mb-3">LOG IN TO YOUR ACCOUNT</h3>
